    ...
    <footer className="border-t border-border bg-foreground text-primary-foreground">
      <div className="container py-6 md:py-12">
        <div className="grid grid-cols-2 gap-6 md:grid-cols-4 md:gap-8">
          <div className="col-span-2 md:col-span-1">
            <div className="mb-2 flex items-center gap-2">
              <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-primary font-display text-xs font-bold text-primary-foreground">O</div>
              <span className="font-display text-base font-bold">Omni Mart</span>
            </div>
            <p className="text-xs opacity-70">Global trusted B2B & B2C marketplace.</p>
          </div>
          <div>
        ...
        <div className="mt-4 border-t border-primary-foreground/10 pt-4 text-center text-xs opacity-50">
          © 2026 Omni Mart. All rights reserved.
        </div>
      </div>
    </footer>
  );
